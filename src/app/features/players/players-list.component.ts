                  ...
                  @for (player of filteredPlayers(); track player.uid) {
                      <tr>
                        ...
                        <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                          <button (click)="openEdit(player)" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300 mr-4">
                              {{ 'COMMON.EDIT' | translate }}
                          </button>
                           <button (click)="deletePlayer(player.uid)" class="text-red-600 hover:text-red-900 dark:text-red-400 dark:hover:text-red-300">
