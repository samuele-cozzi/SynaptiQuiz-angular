                    ...
                    <li class="py-4">
                        ...
                        <div class="flex items-center text-sm">
                            ...
                            <span class="mx-2 px-2 inline-flex text-xs leading-5 font-semibold rounded-full"
                                  [class.bg-green-100]="ans.isCorrect" [class.text-green-800]="ans.isCorrect"
                                  [class.bg-red-100]="!ans.isCorrect" [class.text-red-800]="!ans.isCorrect">
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
               <thead class="bg-gray-50 dark:bg-gray-900">
                  <tr>
                    ...
                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Games Won</th>
                  </tr>
               </thead>
